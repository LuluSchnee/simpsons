...
class SimpsonPersonTest {
    ...
    public void testConstructor_InvalidName_TooShort() throws Exception {
        assertDoesNotThrow(() -> {
            SimpsonPerson Person = new SimpsonPerson("Lena", Gender.FEMALE, null, null, new InteractMediator()); // Short name, will throw exception
    ...
    void setFather()  {
        ...
        assertDoesNotThrow(() -> {
            SimpsonPerson Vater = new SimpsonPerson("Vater", Gender.MALE, null, null, new InteractMediator());
            SimpsonPerson Person = new SimpsonPerson("Lena", Gender.FEMALE, null, null, new InteractMediator()); // Short name, will throw exception
    ...
    void setMother() {
        ...
        assertDoesNotThrow(() -> {
            SimpsonPerson Mutter = new SimpsonPerson("Vater", Gender.MALE, null, null, new InteractMediator());
            SimpsonPerson Person = new SimpsonPerson("Lena", Gender.FEMALE, null, null, new InteractMediator()); // Short name, will throw exception
    ...
    void getNameStateLive() throws Exception {
        String name = "Lena";
SimpsonPerson  Person= new SimpsonPerson(name,Gender.FEMALE,null,null, new InteractMediator());
Person.setState(new live(Person));
  assertEquals(name, Person.getName());
    ...
    void getNameStateExist() throws Exception {
        SimpsonPerson  Person= new SimpsonPerson("lena",Gender.FEMALE,null,null, new InteractMediator());
