public class Create {
    public static void main(String[] args) throws Exception {
        ...
        SimpsonPerson Homer = new SimpsonPerson("Homer", Gender.MALE, null, null,conversation );
        SimpsonPerson Marsh = new SimpsonPerson("Marsh", Gender.FEMALE, null, null, conversation);
        SimpsonPerson Tochter = new SimpsonPerson("Sina", Gender.FEMALE, null, null, conversation);
       ...
       Tochter.interact("hadkljfdaslf",Tochter);
